		...
		var portfolio = [
            {
                category: "branding",
                image: {stock},
                title: "Stocks & Sales <span>x1</span>",
                link: "#none",
            ...
            },
            {
                ...
                title: "Customer Relation<span>x2</span>",
                link: "#none",
            ...
            },
            {
                ...
                title: "Manufacturing <span>x3</span>",
                link: "#none",
            ...
            },
            {
                ...
                title: "Point of Sale <span>x8</span>",
                link: "#none",
		...
		new preLoader(portImage, {
			onComplete: function (load, errors) {
				$.each(portfolio, function (a, b) {
					...
					// ' + image + '
					var portList = $('<figure class="portfolio-view ' + b.category + '" style="width:' + portWidth + 'px;height:' + (portWidth - 113) + 'px"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Image_created_with_a_mobile_phone.png/1280px-Image_created_with_a_mobile_phone.png"><figcaption><h2>' + b.title + '</span></h2><p>' + b.text + '</p><a href="' + b.link + '">View more</a></figcaption></figure>');
